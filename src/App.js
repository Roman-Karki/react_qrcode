...
function App() {
  ...
  return (
    <Container className='container'>
      <Card>
        <h2 className='title'> Generate Download & Scan QR Code </h2>
        <CardContent>
          <Grid container spacing={2}>
            <Grid item  md={6} sm={12} xs={12}>
              ...
              <br />
               {imageUrl ?
               (<a href= {imageUrl} download> <img height="300" width="300" src={imageUrl} alt="img"/> </a>) : null}
               <br />
               {imageUrl ?
               (<h3>Click on QR to Download</h3> ) : null}
            </Grid>
